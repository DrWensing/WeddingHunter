...
func _physics_process(delta):
	...
	if not registered_player.is_empty():
		...
		var x_distance_to_closest_player = closest_player.global_position.x - self.global_position.x 
		var y_distance_to_closest_player = closest_player.global_position.y - self.global_position.y -30#- 160 #offset is a hotfix
